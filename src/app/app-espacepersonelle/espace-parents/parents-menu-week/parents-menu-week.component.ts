...
@Component({
  selector: 'app-parents-menu-week',
  templateUrl: './parents-menu-week.component.html',
  styleUrl: './parents-menu-week.component.css',
})
export class ParentsMenuWeekComponent implements OnInit {
  constructor(
